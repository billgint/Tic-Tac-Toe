...
public class main {
   ...
   public static void initGame() {
	   ...
	   System.out.println("======================");
	   System.out.println("The size of board is scalable. Now please input the size you like, the minimum size is 3X3.");
	   System.out.print("TOTAL ROWS: ");
	   ROWS = in.nextInt();
	   if (ROWS <3) {
		   System.out.println("The game terminated, rows cannot lower than 3.");
		   System.exit(0);
	   }
	   System.out.print("TOTAL COLUMNS: ");
	   COLS = in.nextInt();
	   if (COLS <3) {
		   System.out.println("The game terminated, columns cannot lower than 3.");
		   System.exit(0);
	   }
   ...
   public static boolean hasWon(int theSeed, int currentRow, int currentCol) {
	   ...
	   // 3-in-the-opposite-diagonal ("\"). OKAY
	   temp = 0;
	   exit = false;
	   i = currentRow;
	   j = currentCol;
	   ...
	   /*return (
    		  ...
    		  board[currentRow][0] == theSeed         // 3-in-the-row
